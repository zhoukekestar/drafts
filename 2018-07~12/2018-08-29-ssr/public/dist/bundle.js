...
*/
var aa=__webpack_require__(3),ba=__webpack_require__(0),m=__webpack_require__(7),p=__webpack_require__(2),v=__webpack_require__(1),da=__webpack_require__(8),ea=__webpack_require__(9),fa=__webpack_require__(10),ha=__webpack_require__(4);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "h3",
                    { className: "title" },
                    "This is a counter built using React."
                ),
...
var Counter = function (_React$Component) {
    ...
    function Counter(props) {
        ...
        _this.state = { count: props.count || 1 };
        return _this;
    }
    ...
    _createClass(Counter, [{
        ...
        value: function componentDidMount() {
            ...
            fetch("/api/count").then(function (r) {
                return r.json();
            }).then(function (data) {
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { className: "button", onClick: this.decrement.bind(this) },
                    "-"
                ),
                React.createElement(
                    "span",
