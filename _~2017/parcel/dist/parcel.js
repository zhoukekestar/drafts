...
function t(t) {
  function n(t) {
    for (var n = [], r = 0; r < e.length; r++) e[r] === t ? t = null : n.push(e[r]);e = n;
  }function r(n, r) {
    t = r ? n : u(u({}, t), n);for (var o = e, i = 0; i < o.length; i++) o[i](t);
  }var e = [];return t = t || {}, { action: function (n) {
      return function () {
        for (var e = arguments, o = [t], u = 0; u < arguments.length; u++) o.push(e[u]);var i = n.apply(this, o);null != i && (i.then ? i.then(r) : r(i));
      };
    }, setState: r, subscribe: function (t) {
  ...
  return "function" != typeof t && (t = o(t || [])), function (r) {
    function o(o, c) {
      var f = this,
          s = c.store,
          a = t(s ? s.getState() : {}, o),
          p = n ? e(n, s) : { store: s },
          h = function () {
        var n = t(s ? s.getState() : {}, f.props);for (var r in n) if (n[r] !== a[r]) return a = n, f.setState(null);for (var e in a) if (!(e in n)) return a = n, f.setState(null);
      };this.componentDidMount = function () {
        s.subscribe(h);
      }, this.componentWillUnmount = function () {
        s.unsubscribe(h);
      }, this.render = function (t) {
        return i.h(r, u(u(u({}, p), t), a));
      };
  ...
  return "string" == typeof t && (t = t.split(",")), function (n) {
    for (var r = {}, e = 0; e < t.length; e++) r[t[e]] = n[t[e]];return r;
  };
}function u(t, n) {
  for (var r in n) t[r] = n[r];return t;
}var i = require("preact");r.prototype.render = function (t) {
  return t.children[0];
